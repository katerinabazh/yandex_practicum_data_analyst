...
| [Анализ развлекательного приложения](Анализ развлекательного приложения) | _Основная задача_:  | *pandas, numpy, math, matplotlib, seaborn, datetime, scipy, plotly*, проверка двусторонних гипотез |
