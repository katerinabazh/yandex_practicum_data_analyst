...
| [[Анализ развлекательного приложения](Анализ развлекательного приложения)](https://github.com/katerinabazh/yandex_practicum_data_analyst/tree/master/Анализ%20развлекательного%20приложения) | _Основная задача_:  | *pandas, numpy, math, matplotlib, seaborn, datetime, scipy, plotly*, проверка двусторонних гипотез |
